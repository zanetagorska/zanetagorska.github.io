...
var PortfolioItem = function () {
  function PortfolioItem() {
    ...
    this.portfolioItem = (0, _jquery2.default)(".portfolio-item");
  ...
  _createClass(PortfolioItem, [{
    ...
    value: function addHoverEffect() {
      if (this.windowWidth >= 890) {
        this.portfolioItem.hover(function () {
          (0, _jquery2.default)(this).addClass("portfolio-item--active");
        }, function () {
          (0, _jquery2.default)(this).removeClass("portfolio-item--active");
        });
      } else {
    ...
    key: "changeEffectIfWindowResize",
    value: function changeEffectIfWindowResize() {
...
var _PortfolioItem = __webpack_require__(4);
...
var portfolioItem = new _PortfolioItem2.default();
